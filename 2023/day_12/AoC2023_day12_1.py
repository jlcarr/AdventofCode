"""
Solution to Advent of Code 2023 day 12 part 1

Solved using dynamic programming over the position along the template string, the number of matched streaks, and the current number of contiguous damaged springs.
"""
import time
import sys
